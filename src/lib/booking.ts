...
export const translations = {
  es: {
    ...
    registerSuccess:
      "Cuenta creada. Si el sistema pide confirmación, revisá tu email antes de ingresar.",
    ...
    recoveryCodeSent: "Te enviamos un código para recuperar tu contraseña.",
  ...
  en: {
    ...
    registerSuccess:
      "Account created. If confirmation is required, check your email before signing in.",
    ...
    sendCode: "Send code",
    recoveryCodeSent: "We sent you a code to recover your password.",
  ...
  ru: {
    ...
    registerSuccess:
      "Аккаунт создан. Если требуется подтверждение, проверьте email перед входом.",
    registerError: "Не удалось создать аккаунт. Проверьте данные и попробуйте снова.",
    codeSentTitle: "Мы отправили код",
    ...
    codeResent: "Код отправлен снова. Проверьте email.",
    ...
    recoveryCodeSent: "Мы отправили код для восстановления пароля.",
