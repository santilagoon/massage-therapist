...
export const translations = {
  es: {
    ...
    professionalPanel: "Panel profesional",
    currency: "Moneda",
    arsCurrency: "$ARG",
    usdCurrency: "USD",
    language: "Idioma",
    ...
    registerSuccess:
      "Revisá tu email. Si puede recibir mensajes, vas a ver un código para verificar la cuenta.",
    registerError: "No se pudo crear la cuenta. Revisá los datos e intentá nuevamente.",
    codeSentTitle: "Revisá tu email",
    recoveryCodeTitle: "Código de recuperación",
    enterCodeFor: "Ingresalo abajo para verificar {email}.",
    verificationCode: "Código de verificación",
    didNotGetCode: "¿No llegó el email?",
    resendCode: "Reenviar código",
    useDifferentEmail: "Usar otro email",
    emailVerified: "Email verificado. Ya podés ingresar.",
    codeResent: "Si el email puede recibir mensajes, enviamos un nuevo código.",
    codeVerificationError: "El código no es válido o venció. Intentá nuevamente.",
    codeResendError: "No pudimos reenviar el código. Intentá nuevamente.",
    forgotPassword: "Olvidé mi contraseña",
    sendCode: "Enviar código",
    recoveryCodeSent:
      "Si el email está registrado, vas a recibir un código para recuperar la contraseña.",
    recoveryCodeVerified: "Código verificado. Ingresá una nueva contraseña.",
    recoveryError: "No pudimos enviar el código de recuperación. Intentá nuevamente.",
    newPasswordTitle: "Nueva contraseña",
    newPassword: "Nueva contraseña",
    savePassword: "Guardar contraseña",
    passwordUpdated: "Contraseña actualizada. Ya podés ingresar.",
    passwordUpdateError: "No pudimos actualizar la contraseña. Intentá nuevamente.",
    continueWithGoogle: "Continuar con Google",
    googleLoginError: "No pudimos iniciar sesión con Google. Intentá nuevamente.",
  ...
  en: {
    ...
    registerSuccess:
      "Check your email. If it can receive messages, you will see a code to verify the account.",
    registerError: "The account could not be created. Check the details and try again.",
    codeSentTitle: "Check your email",
    recoveryCodeTitle: "Recovery code",
    enterCodeFor: "Enter it below to verify {email}.",
    verificationCode: "Verification code",
    didNotGetCode: "Did not get the email?",
    resendCode: "Resend code",
    useDifferentEmail: "Use a different email",
    emailVerified: "Email verified. You can now sign in.",
    codeResent: "If the email can receive messages, we sent a new code.",
    codeVerificationError: "The code is invalid or expired. Please try again.",
    codeResendError: "We could not resend the code. Please try again.",
    forgotPassword: "Forgot password",
    sendCode: "Send code",
    recoveryCodeSent:
      "If the email is registered, you will receive a code to recover the password.",
    recoveryCodeVerified: "Code verified. Enter a new password.",
    recoveryError: "We could not send the recovery code. Please try again.",
    newPasswordTitle: "New password",
    newPassword: "New password",
    savePassword: "Save password",
    passwordUpdated: "Password updated. You can now sign in.",
    passwordUpdateError: "We could not update the password. Please try again.",
    continueWithGoogle: "Continue with Google",
    googleLoginError: "We could not sign in with Google. Please try again.",
  ...
  ru: {
    ...
    professionalPanel: "Панель специалиста",
    currency: "Валюта",
    arsCurrency: "$ARG",
    usdCurrency: "USD",
    language: "Язык",
    ...
    adminEyebrow: "Администрирование",
    adminControlPanel: "Панель управления",
    yesterday: "Вчера",
    today: "Сегодня",
    tomorrow: "Завтра",
    sessionsUnit: "сеансы",
    requestsUnit: "запросы",
    appointmentsUnit: "записи",
    ...
    dayAppointments: "Всего за день",
    todayPatients: "Пациенты сегодня",
    todayConfirmed: "Подтверждены",
    ...
    registerSuccess:
      "Проверьте email. Если он может получать письма, вы увидите код для подтверждения аккаунта.",
    registerError: "Не удалось создать аккаунт. Проверьте данные и попробуйте снова.",
    codeSentTitle: "Проверьте email",
    recoveryCodeTitle: "Код восстановления",
    enterCodeFor: "Введите его ниже, чтобы подтвердить {email}.",
    verificationCode: "Код подтверждения",
    didNotGetCode: "Письмо не пришло?",
    resendCode: "Отправить код снова",
    useDifferentEmail: "Использовать другой email",
    emailVerified: "Email подтвержден. Теперь можно войти.",
    codeResent: "Если email может получать письма, мы отправили новый код.",
    codeVerificationError: "Код неверный или истек. Попробуйте снова.",
    codeResendError: "Не удалось отправить код снова. Попробуйте позже.",
    forgotPassword: "Забыли пароль",
    sendCode: "Отправить код",
    recoveryCodeSent:
      "Если email зарегистрирован, вы получите код для восстановления пароля.",
    recoveryCodeVerified: "Код подтвержден. Введите новый пароль.",
    recoveryError: "Не удалось отправить код восстановления. Попробуйте снова.",
    ...
    googleLoginError: "Не удалось войти через Google. Попробуйте снова.",
